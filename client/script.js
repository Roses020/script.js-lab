...
const repeatMyParam = () => {
    //YOUR CODE HERE
    axios.get('http://localhost:3000/repeat/"param"').then(res => { console.log(res.data)
     repeatWord = document.getElementById('repeat-text');
    repeatWord.textContent = res.data;
    repeatWord.style.display = 'block';
...
axios.get('http://localhost:3000/query-test?thisismyquery=anything')
